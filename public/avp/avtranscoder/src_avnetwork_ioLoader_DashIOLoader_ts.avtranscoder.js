        ...
        try {
            ...
            if (this.options.isLive) {
                ...
                if (segmentCount < needSegment) {
                    ...
                    common_util_logger__WEBPACK_IMPORTED_MODULE_3__.warn(`wait for min buffer time, buffer: ${segmentCount * this.mediaPlayList.maxSegmentDuration}, need: ${needSegment * this.mediaPlayList.maxSegmentDuration}`, cheap__fileName__0, 136);
            ...
            if (this.retryCount < this.options.retryCount) {
                this.retryCount++;
                common_util_logger__WEBPACK_IMPORTED_MODULE_3__.error(`failed fetch mpd file, retry(${this.retryCount}/3)`, cheap__fileName__0, 208);
                ...
                resolve();
                common_util_logger__WEBPACK_IMPORTED_MODULE_3__.fatal(`DashLoader: exception, fetch slice error, error: ${error.message}`, cheap__fileName__0, 216);
            }
        }
    }
