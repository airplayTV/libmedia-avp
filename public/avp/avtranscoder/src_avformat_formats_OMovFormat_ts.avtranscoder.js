...
/* harmony import */ var avutil_codecs_ac3__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! avutil/codecs/ac3 */ "./src/avutil/codecs/ac3.ts");
/* harmony import */ var cheap_std_memory__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! cheap/std/memory */ "./src/cheap/std/memory.ts");
/* harmony import */ var _mov_function_getSampleDuration__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./mov/function/getSampleDuration */ "./src/avformat/formats/mov/function/getSampleDuration.ts");
/* harmony import */ var avutil_util_encryption__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! avutil/util/encryption */ "./src/avutil/util/encryption.ts");
const cheap__fileName__5 = "src\\avformat\\formats\\OMovFormat.ts";
...
const defaultOptions = {
    fragmentMode: 0 /* MovFragmentMode.GOP */,
...
class OMovFormat extends _OFormat__WEBPACK_IMPORTED_MODULE_4__["default"] {
    ...
    init(formatContext) {
        ...
        if (videoStream
            ...
            this.annexb2AvccFilter = new _bsf_h2645_Annexb2AvccFilter__WEBPACK_IMPORTED_MODULE_21__["default"](this.options.reverseSpsInAvcc);
        ...
        this.avpacket = (0,avutil_util_avpacket__WEBPACK_IMPORTED_MODULE_20__.createAVPacket)();
        return 0;
    }
    async destroy(formatContext) {
        ...
        if (this.avpacket) {
            (0,avutil_util_avpacket__WEBPACK_IMPORTED_MODULE_20__.destroyAVPacket)(this.avpacket);
            this.avpacket = 0;
        }
    }
    /*
    ...
    writeHeader(formatContext) {
        ...
        if (this.options.fragment) {
            ...
            common_util_array__WEBPACK_IMPORTED_MODULE_11__.each(formatContext.streams, (stream, index) => {
                ...
                const encryption = this.options.encryption || stream.metadata["encryption" /* AVStreamMetadataKey.ENCRYPTION */];
                if (encryption) {
    ...
    updateCurrentFragment(formatContext, currentDts) {
        if (this.context.currentFragment.firstWrote) {
            common_util_array__WEBPACK_IMPORTED_MODULE_11__.each(this.context.currentFragment.tracks, (track) => {
                ...
                if (track.cenc) {
                    if (track.cenc.sampleSizes.length === 1 || (0,_function_arrayItemSame__WEBPACK_IMPORTED_MODULE_18__["default"])(track.cenc.sampleSizes)) {
            ...
            common_util_array__WEBPACK_IMPORTED_MODULE_11__.each(this.context.currentFragment.tracks, (track) => {
                ...
                if (track.cenc) {
                    if (track.cenc.offsetPos) {
                        (0,_function_rewriteIO__WEBPACK_IMPORTED_MODULE_17__["default"])(formatContext.ioWriter, track.cenc.offsetPos, track.cenc.offset, 'int32');
                    }
                }
                track.buffers = [];
                track.sampleFlags = [];
    ...
    handleEAC3(avpacket, stream) {
        ...
        const info = avutil_codecs_ac3__WEBPACK_IMPORTED_MODULE_24__.parseHeader((0,cheap_std_memory__WEBPACK_IMPORTED_MODULE_25__.mapUint8Array)(cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[20](avpacket + 24), cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[15](avpacket + 28)));
    ...
    writeAVPacket(formatContext, avpacket) {
        ...
        if ((stream.codecpar.codecId === 27 /* AVCodecID.AV_CODEC_ID_H264 */
            ...
            && (cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[15](avpacket + 36) & 64 /* AVPacketFlags.AV_PKT_FLAG_H26X_ANNEXB */)) {
        ...
        if (this.context.fragment) {
            ...
            if (track) {
                ...
                if (cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[17](avpacket + 48) > 0) {
                    track.sampleDurations.push(Number((0,avutil_util_rational__WEBPACK_IMPORTED_MODULE_19__.avRescaleQ)(cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[17](avpacket + 48), (0,cheap_std_structAccess__WEBPACK_IMPORTED_MODULE_3__["default"])(avpacket + 72, _avutil_struct_rational__WEBPACK_IMPORTED_MODULE_2__.Rational), stream.timeBase)));
                }
                ...
                if (stream.codecpar.codecType === 0 /* AVMediaType.AVMEDIA_TYPE_VIDEO */) {
                    ...
                    track.sampleCompositionTimeOffset.push(Number((pts !== avutil_constant__WEBPACK_IMPORTED_MODULE_15__.NOPTS_VALUE_BIGINT ? pts : dts) - dts));
                    track.sampleFlags.push(flag);
                }
                const sideData = (0,avutil_util_avpacket__WEBPACK_IMPORTED_MODULE_20__.getSideData)(avpacket + 40, avpacket + 44, 25 /* AVPacketSideDataType.AV_PKT_DATA_ENCRYPTION_INFO */);
                const cenc = this.context.cencs && this.context.cencs[streamContext.trackId];
                if (sideData && cenc) {
                    const info = (0,avutil_util_encryption__WEBPACK_IMPORTED_MODULE_27__.encryptionSideData2Info)((0,cheap_std_memory__WEBPACK_IMPORTED_MODULE_25__.mapUint8Array)(cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[20](sideData), cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[25](sideData + 4)));
                    if (!track.cenc) {
                        track.cenc = {
                            sampleCount: 0,
                ...
                track.sampleCount++;
                streamContext.lastPts = common_util_bigint__WEBPACK_IMPORTED_MODULE_23__.max(streamContext.lastPts, pts + (duration !== avutil_constant__WEBPACK_IMPORTED_MODULE_15__.NOPTS_VALUE_BIGINT ? duration : BigInt(0)));
            ...
            if (!streamContext.firstWrote) {
                ...
                streamContext.startCT = Number((pts !== avutil_constant__WEBPACK_IMPORTED_MODULE_15__.NOPTS_VALUE_BIGINT ? pts : dts) - dts);
            ...
            if (pts >= 0) {
                if (streamContext.startPts === avutil_constant__WEBPACK_IMPORTED_MODULE_15__.NOPTS_VALUE_BIGINT) {
                    streamContext.startPts = pts;
                }
                else {
                    streamContext.startPts = common_util_bigint__WEBPACK_IMPORTED_MODULE_23__.min(streamContext.startPts, pts);
                }
            }
            if (stream.codecpar.codecType === 0 /* AVMediaType.AVMEDIA_TYPE_VIDEO */) {
                const ctts = Number((pts !== avutil_constant__WEBPACK_IMPORTED_MODULE_15__.NOPTS_VALUE_BIGINT ? pts : dts) - dts);
            ...
            streamContext.lastPts = common_util_bigint__WEBPACK_IMPORTED_MODULE_23__.max(streamContext.lastPts, pts + (duration !== avutil_constant__WEBPACK_IMPORTED_MODULE_15__.NOPTS_VALUE_BIGINT ? duration : BigInt(0)));
            streamContext.lastDts = dts;
            streamContext.lastDuration = Number(duration);
        }
        return 0;
    }
    writeTrailer(formatContext) {
        if (!this.context.fragment) {
            ...
            common_util_array__WEBPACK_IMPORTED_MODULE_11__.each(formatContext.streams, (stream) => {
                ...
                const streamDuration = (0,avutil_util_rational__WEBPACK_IMPORTED_MODULE_19__.avRescaleQ)((0,_mov_function_getSampleDuration__WEBPACK_IMPORTED_MODULE_26__["default"])(streamContext), stream.timeBase, { den: 1000, num: 1 });
            ...
            if (mdat.size > avutil_constant__WEBPACK_IMPORTED_MODULE_15__.UINT32_MAX) {
                ...
                formatContext.ioWriter.seek(mdat.pos - BigInt(8));
                // overwrite 'free' placeholder atom
                formatContext.ioWriter.writeUint32(1);
                formatContext.ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_6__["default"])("mdat" /* BoxType.MDAT */));
                formatContext.ioWriter.writeUint64(BigInt(mdat.size) + BigInt(8));
...
/***/ "./src/avformat/formats/mov/function/getSampleDuration.ts":
/*!****************************************************************!*\
  !*** ./src/avformat/formats/mov/function/getSampleDuration.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ getSampleDuration)
/* harmony export */ });
/* harmony import */ var avutil_constant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! avutil/constant */ "./src/avutil/constant.ts");
/*
...
function getSampleDuration(context) {
    if (context.startPts !== avutil_constant__WEBPACK_IMPORTED_MODULE_0__.NOPTS_VALUE_BIGINT) {
        return context.lastPts - context.startPts;
    }
    if (context.startDts === avutil_constant__WEBPACK_IMPORTED_MODULE_0__.NOPTS_VALUE_BIGINT) {
        return context.lastPts;
    }
    return context.lastPts - (context.startDts + BigInt(context.startCT >> 0));
}
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            children: [
                                ...
                                {
                                    type: context.use64Mdat ? "co64" /* BoxType.CO64 */ : "stco" /* BoxType.STCO */
                                }
                            ]
                        }
                    ]
...
const MoofTrafBoxLayout = function (track) {
    return [
        {
        ...
        track.cenc && (track.cenc.defaultSampleInfoSize || track.cenc.sampleSizes.length)
            ?
                {
                    type: "saiz" /* BoxType.SAIZ */
                }
            : null,
        track.cenc && (track.cenc.defaultSampleInfoSize || track.cenc.sampleSizes.length)
            ?
                {
                    type: "saio" /* BoxType.SAIO */
                }
            : null,
        track.cenc
            ?
                {
                    type: "senc" /* BoxType.SENC */
                }
            : null
    ];
};
...
/* harmony import */ var cheap_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cheap/symbol */ "./src/cheap/symbol.ts");
/* harmony import */ var cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! cheap/ctypeEnumRead */ "./src/cheap/ctypeEnumRead.ts");
/* harmony import */ var _function_mktag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../function/mktag */ "./src/avformat/function/mktag.ts");
/* harmony import */ var _boxType__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./boxType */ "./src/avformat/formats/mov/boxType.ts");
...
/* harmony import */ var _writing_writers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./writing/writers */ "./src/avformat/formats/mov/writing/writers.ts");
/* harmony import */ var _layout__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./layout */ "./src/avformat/formats/mov/layout.ts");
/* harmony import */ var _function_updatePositionSize__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./function/updatePositionSize */ "./src/avformat/formats/mov/function/updatePositionSize.ts");
...
/* harmony import */ var avutil_util_encryption__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! avutil/util/encryption */ "./src/avutil/util/encryption.ts");
...
function writeFtyp(ioWriter, context) {
    ...
    ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("ftyp" /* BoxType.FTYP */));
    ioWriter.writeUint32(context.majorBrand || (0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])('isom'));
    ioWriter.writeUint32(context.minorVersion || 512);
    common_util_array__WEBPACK_IMPORTED_MODULE_4__.each(context.compatibleBrand, (value) => {
        ioWriter.writeUint32(value);
    });
    updateSize(ioWriter, pointer, Number(ioWriter.getPos() - now));
    if (context.isom) {
        ioWriter.writeUint32(8);
        ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("wide" /* BoxType.WIDE */));
    }
    else if (!context.fragment) {
        ioWriter.writeUint32(8);
        ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("free" /* BoxType.FREE */));
    }
}
function writeEmptyBox(ioWriter, tag) {
    const isFullBox = common_util_array__WEBPACK_IMPORTED_MODULE_4__.has(_boxType__WEBPACK_IMPORTED_MODULE_3__.FullBoxs, tag);
    ioWriter.writeUint32(isFullBox ? 12 : 8);
    ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])(tag));
    if (isFullBox) {
        // version & flags
        ioWriter.writeUint32(0);
    }
...
function writeLayout(ioWriter, layouts, stream, movContext) {
    common_util_array__WEBPACK_IMPORTED_MODULE_4__.each(layouts, (layout) => {
        if (!layout) {
            return true;
        }
        if (_writing_writers__WEBPACK_IMPORTED_MODULE_5__["default"][layout.type]) {
            _writing_writers__WEBPACK_IMPORTED_MODULE_5__["default"][layout.type](ioWriter, stream, movContext);
        }
        else if (layout.children) {
            const pos = ioWriter.getPos();
            ioWriter.writeUint32(0);
            ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])(layout.type));
...
function writePssh(ioWriter, formatContext, movContext) {
    const pssh = [];
    function has(info) {
        if (!pssh.length) {
            return false;
        ...
        for (let i = 0; i < pssh.length; i++) {
            const item = pssh[i];
            if (!common_util_array__WEBPACK_IMPORTED_MODULE_4__.same(item.systemId, info.systemId)) {
                return false;
            }
            ...
            for (let i = 0; i < item.keyIds.length; i++) {
                if (!common_util_array__WEBPACK_IMPORTED_MODULE_4__.same(item.keyIds[i], info.keyIds[i])) {
                    return false;
                }
            }
            if (!common_util_array__WEBPACK_IMPORTED_MODULE_4__.same(item.data, info.data)) {
                return false;
            }
        }
        return true;
    }
    common_util_array__WEBPACK_IMPORTED_MODULE_4__.each(formatContext.streams, (stream) => {
        const sideData = (0,avutil_util_avpacket__WEBPACK_IMPORTED_MODULE_8__.getSideData)(stream.codecpar[cheap_symbol__WEBPACK_IMPORTED_MODULE_0__.symbolStructAddress] + 20, stream.codecpar[cheap_symbol__WEBPACK_IMPORTED_MODULE_0__.symbolStructAddress] + 24, 24 /* AVPacketSideDataType.AV_PKT_DATA_ENCRYPTION_INIT_INFO */);
        if (sideData) {
            const infos = (0,avutil_util_encryption__WEBPACK_IMPORTED_MODULE_9__.encryptionSideData2InitInfo)((0,cheap_std_memory__WEBPACK_IMPORTED_MODULE_10__.mapUint8Array)(cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[20](sideData), cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[25](sideData + 4)));
            infos.forEach((info) => {
                if (!has(info)) {
                    pssh.push(info);
                }
    ...
    if (pssh.length) {
        pssh.forEach((info) => {
            const pos = ioWriter.getPos();
            ioWriter.writeUint32(0);
            ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("pssh" /* BoxType.PSSH */));
            // version
...
function writeMoov(ioWriter, formatContext, movContext) {
    const pos = ioWriter.getPos();
    ioWriter.writeUint32(0);
    ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("moov" /* BoxType.MOOV */));
    _writing_writers__WEBPACK_IMPORTED_MODULE_5__["default"]["mvhd" /* BoxType.MVHD */](ioWriter, null, movContext);
    common_util_array__WEBPACK_IMPORTED_MODULE_4__.each(formatContext.streams, (stream) => {
        const pos = ioWriter.getPos();
        ioWriter.writeUint32(0);
        ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("trak" /* BoxType.TRAK */));
        writeLayout(ioWriter, movContext.fragment
            ? _layout__WEBPACK_IMPORTED_MODULE_6__.FragmentTrackBoxLayoutMap[stream.codecpar.codecType](movContext)
            : _layout__WEBPACK_IMPORTED_MODULE_6__.TrackBoxLayoutMap[stream.codecpar.codecType](movContext), stream, movContext);
        movContext.boxsPositionInfo.push({
            pos,
    ...
    if (movContext.fragment) {
        const pos = ioWriter.getPos();
        ioWriter.writeUint32(0);
        ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("mvex" /* BoxType.MVEX */));
        common_util_array__WEBPACK_IMPORTED_MODULE_4__.each(formatContext.streams, (stream) => {
            _writing_writers__WEBPACK_IMPORTED_MODULE_5__["default"]["trex" /* BoxType.TREX */](ioWriter, stream, movContext);
        });
        movContext.boxsPositionInfo.push({
            pos,
    ...
    (0,_function_updatePositionSize__WEBPACK_IMPORTED_MODULE_7__["default"])(ioWriter, movContext);
}
function writeMoof(ioWriter, formatContext, movContext) {
    const pos = ioWriter.getPos();
    ioWriter.writeUint32(0);
    ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("moof" /* BoxType.MOOF */));
    _writing_writers__WEBPACK_IMPORTED_MODULE_5__["default"]["mfhd" /* BoxType.MFHD */](ioWriter, null, movContext);
    common_util_array__WEBPACK_IMPORTED_MODULE_4__.each(movContext.currentFragment.tracks, (track) => {
        ...
        const pos = ioWriter.getPos();
        ioWriter.writeUint32(0);
        ioWriter.writeUint32((0,_function_mktag__WEBPACK_IMPORTED_MODULE_2__["default"])("traf" /* BoxType.TRAF */));
        const stream = formatContext.streams.find((stream) => {
            return stream.privData.trackId === track.trackId;
        });
        writeLayout(ioWriter, (0,_layout__WEBPACK_IMPORTED_MODULE_6__.MoofTrafBoxLayout)(track), stream, movContext);
        movContext.boxsPositionInfo.push({
            pos,
...
/* harmony export */ });
/* harmony import */ var cheap_std_memory__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cheap/std/memory */ "./src/cheap/std/memory.ts");
/* harmony import */ var avutil_util_nalu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! avutil/util/nalu */ "./src/avutil/util/nalu.ts");
/* harmony import */ var avutil_codecs_h264__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! avutil/codecs/h264 */ "./src/avutil/codecs/h264.ts");
/*
...
function write(ioWriter, stream, movContext) {
    ...
    if (extradata && avutil_util_nalu__WEBPACK_IMPORTED_MODULE_1__.isAnnexb(extradata)) {
        extradata = avutil_codecs_h264__WEBPACK_IMPORTED_MODULE_2__.annexbExtradata2AvccExtradata(extradata);
    }
    // size
...
const cheap__fileName__0 = "src\\avformat\\formats\\mov\\writing\\ctts.ts";
...
const cheap__fileName__0 = "src\\avformat\\formats\\mov\\writing\\dfla.ts";
...
function write(ioWriter, stream, movContext) {
    ...
    if (!extradata || extradata.length !== avutil_codecs_flac__WEBPACK_IMPORTED_MODULE_2__.FLAC_STREAMINFO_SIZE) {
        common_util_logger__WEBPACK_IMPORTED_MODULE_1__.error('invalid extradata', cheap__fileName__0, 57);
    }
    else {
        // size
...
/* harmony import */ var _function_getSampleDuration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../function/getSampleDuration */ "./src/avformat/formats/mov/function/getSampleDuration.ts");
/*
...
function write(ioWriter, stream, movContext) {
    const streamContext = stream.privData;
    let duration = (0,avutil_util_rational__WEBPACK_IMPORTED_MODULE_1__.avRescaleQ)((0,_function_getSampleDuration__WEBPACK_IMPORTED_MODULE_2__["default"])(streamContext), stream.timeBase, {
...
function writeMatrix(ioWriter, a, b, c, d, tx, ty) {
    ...
    ioWriter.writeInt32(1073741824);
}
...
function write(ioWriter, stream, movContext) {
    ...
    if (stream) {
        ...
        if (stream.codecpar.codecType === 1 /* AVMediaType.AVMEDIA_TYPE_AUDIO */) {
            ...
            if (stream.metadata["handlerName" /* AVStreamMetadataKey.HANDLER_NAME */]) {
                descr = stream.metadata["handlerName" /* AVStreamMetadataKey.HANDLER_NAME */];
            }
...
/* harmony import */ var cheap_std_memory__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cheap/std/memory */ "./src/cheap/std/memory.ts");
/* harmony import */ var avutil_util_nalu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! avutil/util/nalu */ "./src/avutil/util/nalu.ts");
/* harmony import */ var avutil_codecs_hevc__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! avutil/codecs/hevc */ "./src/avutil/codecs/hevc.ts");
/*
...
function write(ioWriter, stream, movContext) {
    ...
    if (extradata && avutil_util_nalu__WEBPACK_IMPORTED_MODULE_1__.isAnnexb(extradata)) {
        extradata = avutil_codecs_hevc__WEBPACK_IMPORTED_MODULE_2__.annexbExtradata2AvccExtradata(extradata);
    }
    // size
    ioWriter.writeUint32(8 + (extradata ? extradata.length : 0));
    // tag
...
/* harmony export */ });
/* harmony import */ var avutil_constant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! avutil/constant */ "./src/avutil/constant.ts");
/* harmony import */ var _function_getSampleDuration__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../function/getSampleDuration */ "./src/avformat/formats/mov/function/getSampleDuration.ts");
/*
...
function write(ioWriter, stream, movContext) {
    const streamContext = stream.privData;
    const duration = (0,_function_getSampleDuration__WEBPACK_IMPORTED_MODULE_1__["default"])(streamContext);
    const creationTime = stream.metadata["creationTime" /* AVStreamMetadataKey.CREATION_TIME */] || 0;
    const modificationTime = stream.metadata["modificationTime" /* AVStreamMetadataKey.MODIFICATION_TIME */] || 0;
    const languge = stream.metadata["language" /* AVStreamMetadataKey.LANGUAGE */] || 21956;
...
/***/ "./src/avformat/formats/mov/writing/saio.ts":
/*!**************************************************!*\
  !*** ./src/avformat/formats/mov/writing/saio.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function write(ioWriter, stream, movContext) {
    ...
    ioWriter.writeUint32(20);
    // tag
    ioWriter.writeString("saio" /* BoxType.SAIO */);
    ioWriter.writeUint32(0);
    ioWriter.writeUint32(1);
...
/***/ "./src/avformat/formats/mov/writing/saiz.ts":
/*!**************************************************!*\
  !*** ./src/avformat/formats/mov/writing/saiz.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function write(ioWriter, stream, movContext) {
    ...
    ioWriter.writeUint32(0);
    // tag
    ioWriter.writeString("saiz" /* BoxType.SAIZ */);
    ioWriter.writeUint32(0);
...
/***/ "./src/avformat/formats/mov/writing/senc.ts":
/*!**************************************************!*\
  !*** ./src/avformat/formats/mov/writing/senc.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function write(ioWriter, stream, movContext) {
    ...
    ioWriter.writeUint32(0);
    // tag
    ioWriter.writeString("senc" /* BoxType.SENC */);
...
/* harmony export */ });
/* harmony import */ var common_util_logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! common/util/logger */ "./src/common/util/logger.ts");
const cheap__fileName__0 = "src\\avformat\\formats\\mov\\writing\\stsc.ts";
...
function writeSinf(ioWriter, stream, movContext) {
    const streamContext = stream.privData;
    const cenc = movContext.cencs[streamContext.trackId];
    const pos = ioWriter.getPos();
    // size
    ioWriter.writeUint32(0);
    ioWriter.writeString("sinf" /* BoxType.SINF */);
    ioWriter.writeUint32(12);
    ioWriter.writeString("frma" /* BoxType.FRMA */);
    ioWriter.writeString(getTag(stream.codecpar));
    ioWriter.writeUint32(20);
    ioWriter.writeString("schm" /* BoxType.SCHM */);
    ioWriter.writeUint32(0);
    ioWriter.writeUint32(cenc.schemeType || (0,_function_mktag__WEBPACK_IMPORTED_MODULE_16__["default"])('cenc'));
    ...
    movContext.boxsPositionInfo.push({
        pos,
        type: "sinf" /* BoxType.SINF */,
        size: Number(ioWriter.getPos() - pos)
    });
}
function writeAudioTagHeader(ioWriter, stream, movContext) {
...
function writeAudioTagCodecpar(ioWriter, stream, movContext) {
...
function writeEncaTag(ioWriter, stream, movContext) {
    const pos = ioWriter.getPos();
    // size
    ioWriter.writeUint32(0);
    ioWriter.writeString("enca" /* BoxType.ENCA */);
    writeAudioTagHeader(ioWriter, stream, movContext);
    writeSinf(ioWriter, stream, movContext);
    writeAudioTagCodecpar(ioWriter, stream, movContext);
    movContext.boxsPositionInfo.push({
        pos,
        type: "enca" /* BoxType.ENCA */,
        size: Number(ioWriter.getPos() - pos)
    });
}
function writeVideoTagHeader(ioWriter, stream, movContext) {
...
function writeVideoTagCodecpar(ioWriter, stream, movContext) {
    const tag = getTag(stream.codecpar);
...
function writeEncvTag(ioWriter, stream, movContext) {
    const pos = ioWriter.getPos();
    // size
    ioWriter.writeUint32(0);
    ioWriter.writeString("encv" /* BoxType.ENCV */);
    writeVideoTagHeader(ioWriter, stream, movContext);
    writeSinf(ioWriter, stream, movContext);
    writeVideoTagCodecpar(ioWriter, stream, movContext);
    movContext.boxsPositionInfo.push({
        pos,
        type: "encv" /* BoxType.ENCV */,
        size: Number(ioWriter.getPos() - pos)
    });
}
...
/* harmony export */ });
/* harmony import */ var common_util_logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! common/util/logger */ "./src/common/util/logger.ts");
const cheap__fileName__0 = "src\\avformat\\formats\\mov\\writing\\stts.ts";
...
/* harmony import */ var _function_getSampleDuration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../function/getSampleDuration */ "./src/avformat/formats/mov/function/getSampleDuration.ts");
/*
...
function write(ioWriter, stream, movContext) {
    const streamContext = stream.privData;
    const duration = (0,avutil_util_rational__WEBPACK_IMPORTED_MODULE_2__.avRescaleQ)((0,_function_getSampleDuration__WEBPACK_IMPORTED_MODULE_3__["default"])(streamContext), stream.timeBase, {
        den: movContext.timescale,
        num: 1
    });
    const creationTime = stream.metadata["creationTime" /* AVStreamMetadataKey.CREATION_TIME */] || 0;
    ...
    const sar = (0,avutil_util_rational__WEBPACK_IMPORTED_MODULE_2__.avQ2D)(stream.codecpar.sampleAspectRatio);
    ...
    // reserved
    ioWriter.writeInt16(0);
    const matrix = stream.metadata["matrix" /* AVStreamMetadataKey.MATRIX */];
    if (matrix) {
        (0,_function_writeMatrix__WEBPACK_IMPORTED_MODULE_1__["default"])(ioWriter, matrix[0], matrix[1], matrix[3], matrix[4], matrix[6], matrix[7]);
    }
    else {
        (0,_function_writeMatrix__WEBPACK_IMPORTED_MODULE_1__["default"])(ioWriter, 1, 0, 0, 1, 0, 0);
    }
...
/* harmony import */ var cheap_std_memory__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cheap/std/memory */ "./src/cheap/std/memory.ts");
/* harmony import */ var avutil_util_nalu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! avutil/util/nalu */ "./src/avutil/util/nalu.ts");
/* harmony import */ var avutil_codecs_vvc__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! avutil/codecs/vvc */ "./src/avutil/codecs/vvc.ts");
/*
...
function write(ioWriter, stream, movContext) {
    ...
    if (extradata && avutil_util_nalu__WEBPACK_IMPORTED_MODULE_1__.isAnnexb(extradata)) {
        extradata = avutil_codecs_vvc__WEBPACK_IMPORTED_MODULE_2__.annexbExtradata2AvccExtradata(extradata);
    }
    // size
...
/* harmony import */ var _saiz__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./saiz */ "./src/avformat/formats/mov/writing/saiz.ts");
/* harmony import */ var _saio__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./saio */ "./src/avformat/formats/mov/writing/saio.ts");
/* harmony import */ var _senc__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./senc */ "./src/avformat/formats/mov/writing/senc.ts");
/*
...
const writers = {
    ...
    ["saio" /* BoxType.SAIO */]: _saio__WEBPACK_IMPORTED_MODULE_23__["default"],
    ["saiz" /* BoxType.SAIZ */]: _saiz__WEBPACK_IMPORTED_MODULE_22__["default"],
    ["senc" /* BoxType.SENC */]: _senc__WEBPACK_IMPORTED_MODULE_24__["default"]
};
