"use strict";
(self["webpackChunkAVTranscoder"] = self["webpackChunkAVTranscoder"] || []).push([["src_avformat_formats_IWebVttFormat_ts"],{
...
/***/ "./src/avformat/formats/IWebVttFormat.ts":
/*!***********************************************!*\
  !*** ./src/avformat/formats/IWebVttFormat.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class IWebVttFormat extends _IFormat__WEBPACK_IMPORTED_MODULE_4__["default"] {
    ...
    async readAVPacket(formatContext, avpacket) {
        ...
        if (cue.options) {
            const buffer = common_util_text__WEBPACK_IMPORTED_MODULE_9__.encode(cue.options);
            const data = (0,avutil_util_mem__WEBPACK_IMPORTED_MODULE_6__.avMalloc)(buffer.length);
            (0,cheap_std_memory__WEBPACK_IMPORTED_MODULE_5__.memcpyFromUint8Array)(data, buffer.length, buffer);
            (0,avutil_util_avpacket__WEBPACK_IMPORTED_MODULE_7__.addAVPacketSideData)(avpacket, 17 /* AVPacketSideDataType.AV_PKT_DATA_WEBVTT_SETTINGS */, data, buffer.length);
        }
...
//# sourceMappingURL=src_avformat_formats_IWebVttFormat_ts.avtranscoder.js.map