...
class OFlvFormat extends _OFormat__WEBPACK_IMPORTED_MODULE_4__["default"] {
    ...
    writeAVPacket(formatContext, avpacket) {
        ...
        if (!stream) {
            common_util_logger__WEBPACK_IMPORTED_MODULE_16__.warn(`can not found the stream width the packet\'s streamIndex: ${cheap_ctypeEnumRead__WEBPACK_IMPORTED_MODULE_1__.CTypeEnumRead[15](avpacket + 32)}, ignore it`, cheap__fileName__0, 234);
            return;
        }
