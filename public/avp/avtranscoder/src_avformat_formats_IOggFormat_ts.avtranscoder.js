"use strict";
(self["webpackChunkAVTranscoder"] = self["webpackChunkAVTranscoder"] || []).push([["src_avformat_formats_IOggFormat_ts"],{
...
/***/ "./src/avformat/formats/IOggFormat.ts":
/*!********************************************!*\
  !*** ./src/avformat/formats/IOggFormat.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _ogg_OggPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ogg/OggPage */ "./src/avformat/formats/ogg/OggPage.ts");
...
/* harmony import */ var _ogg_opus__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ogg/opus */ "./src/avformat/formats/ogg/opus.ts");
/* harmony import */ var _ogg_vorbis__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ogg/vorbis */ "./src/avformat/formats/ogg/vorbis.ts");
...
class IOggFormat extends _IFormat__WEBPACK_IMPORTED_MODULE_8__["default"] {
    ...
    constructor() {
        super();
        this.page = new _ogg_OggPage__WEBPACK_IMPORTED_MODULE_2__.OggPage();
    ...
    async createStream(formatContext, payload) {
        ...
        if (signature === 'OpusHead') {
            ...
            const idPage = new _ogg_vorbis__WEBPACK_IMPORTED_MODULE_5__.VorbisOggsIdPage();
            idPage.read(ioReader);
            const commentPage = new _ogg_vorbis__WEBPACK_IMPORTED_MODULE_5__.VorbisOggsCommentPage();
            payload = await this.getNextSegment(formatContext);
            ioReader = new common_io_IOReaderSync__WEBPACK_IMPORTED_MODULE_12__["default"](payload.length, false);
            ioReader.appendBuffer(payload);
            commentPage.read(ioReader);
            ...
            if (type === 0) {
                ...
                ioReader.peekBuffer(len, (0,cheap_std_memory__WEBPACK_IMPORTED_MODULE_9__.mapUint8Array)(data, len));
                ioReader.skip(10);
                ...
                const commentPage = new _ogg_OggPage__WEBPACK_IMPORTED_MODULE_2__.OggsCommentPage();
                payload = await this.getNextSegment(formatContext);
                ioReader = new common_io_IOReaderSync__WEBPACK_IMPORTED_MODULE_12__["default"](payload.length - 4, false);
            ...
            const data = (0,avutil_util_mem__WEBPACK_IMPORTED_MODULE_10__.avMalloc)(payload.length);
            (0,cheap_std_memory__WEBPACK_IMPORTED_MODULE_9__.memcpyFromUint8Array)(data, payload.length, payload);
            stream.codecpar.extradata = data;
            stream.codecpar.extradataSize = payload.length;
            ioReader.seek(BigInt(36));
            stream.codecpar.sampleRate = ioReader.readUint32();
            ioReader.seek(BigInt(48));
    ...
    async readAVPacket(formatContext, avpacket) {
        ...
        try {
            ...
            const stream = formatContext.streams.find((stream) => {
                return stream.privData && stream.privData.serialNumber === this.page.serialNumber;
            });
            if (stream) {
    ...
    async seek(formatContext, stream, timestamp, flags) {
        ...
        if (flags & 2 /* AVSeekFlags.BYTE */) {
            ...
            if (pointPts < BigInt(10000)) {
                common_util_logger__WEBPACK_IMPORTED_MODULE_3__.debug(`seek pts is earlier then 10s, seek to first packet pos(${this.firstPos}) directly`, cheap__fileName__0, 571);
...
//# sourceMappingURL=src_avformat_formats_IOggFormat_ts.avtranscoder.js.map