...
export declare function getSizeExpressionType(node: ts.Node): ts.Type;
...
export declare function checkConditionCompile(node: ts.Node): any;
export declare function hasDefined(node: ts.Node): any;
export declare function createBitInt(value: number): ts.BigIntLiteral | ts.CallExpression;
export declare function createPointerOperand(value: number | ts.Expression): ts.Expression;
